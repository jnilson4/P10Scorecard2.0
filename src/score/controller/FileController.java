...
{
	public static void saveFile(ScoreController baseController, String fileName, String contents)
	{
		try
		{
			File saveFile;
	...
	public static String readFile(ScoreController baseController, String fileName)
	{
		String fileContents = "";
